...
<body>
    ...
    <div id="openedProduct-desc">
        Изделие предназначено для кошек. Ваш домашний питомец будет с удовольствием точить когти. А отдохнуть он сможет либо на самой когтеточке. Она принесет пользу не только вашему питомцу, но и вам, так как он сохранит мебель от когтей и шерсти.
    </div>
    <br />
    <br />
    <ul>
        <li>
            ...
            <span class="item__cor">4312 г</span>
        </li>
        ...
        <li>
            ...
            <span class="item__cor"> 13-21 кг/см</span>
        </li>
    </ul>
    <br />
